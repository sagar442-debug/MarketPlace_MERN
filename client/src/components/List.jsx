...
const List = ({ product }) => {
  ...
  const onUpdate = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        console.error("There was an error while fetching the data");
      }
  ...
  return (
    <div>
      <div className="lists-component bg-gray-200 py-3 px-5 rounded-xl flex justify-between items-center mt-3">
        ...
        <div className=" absolute top-36 left-[38%]"></div>
      </div>
      <div className=" ">
        <div
          className={`${hide} bg-black min-h-[108vh] min-w-[99vw] absolute top-0 left-0 opacity-25`}
        ></div>
        <form
          onSubmit={handleSubmit}
          className={`${hide} bg-white absolute  left-5 md:left-[30%] top-[15%] lg:left-[37%] z-10 shadow-[0_30px_30px_0px_rgba(0,0,0,0.5)] border-[1px] rounded px-8 pt-6 pb-8 mb-4`}
        >
          <div className="mb-4">
